...
DATA3A<-function(n,d,r1,r2,r3,r4,r5,r6,r7,r8,C1,C2,C3,C4,C5,C6,C7,C8,C9){
...
save(LISTA,file=paste("E. Rmarkdown/2022 9 Regime/del 60/10000/SIMUBCDBEA.(",REPLICATE,").RData",sep = ""))
}