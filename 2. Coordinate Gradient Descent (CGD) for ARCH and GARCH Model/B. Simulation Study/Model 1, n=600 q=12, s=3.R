...
setwd("C:/Users/mjaf8/Dropbox/Journal Papers drafts/2020/Simulation Studies-Rcode/B. Pure GARCH models/B. Simulation Study")
### LOAD R PACKAGES #######################################
library(rpgm)
library(robustbase)
library(mvtnorm)
...
coefARCH<-cbind(paraGA0, paraGAa1, paraGAa2, paraGAa3,paraGAa4,
                         ...
                         paraGAa9, paraGAa10, paraGAa11,paraGAa12,0,0,0)

LAGNONZERO<-c(1,2,5,7,11,13)   #LOCATION OF NONZERO PARAMETERS
LAGNONZERO2<-c(1,1,0,0,1,0,1,0,0,0,1,0,1,0,0,0)  #1: non-zero 0: zero
...
if( (norm(matrix(BEFORE-PARAs1CGD),type = "1") < 0.00001) || (CYCLEGCD==10000) ){
  ITERFULL<-FALSE
}
CYCLEGCD<-CYCLEGCD+1
  }
...
cat("n=",SamSize,"Replication=",maxREP,OUTA,file="./Results/Ver1/Model 1/Model1n600q12s3.txt",sep="\n", append = FALSE)
