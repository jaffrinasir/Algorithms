...
coefARCH<-cbind(paraGA0, paraGAa1, paraGAa2, paraGAa3,paraGAa4,
                         ...
                         paraGAa9, paraGAa10, paraGAa11,paraGAa12,matrix(0,ncol=38))

LAGNONZERO<-c(1,2,5,7,11,13)   #LOCATION OF NONZERO PARAMETERS
LAGNONZERO2<-c(1,1,0,0,1,0,1,0,0,0,1,0,1,rep(0,38))  #1: non-zero 0: zero
...
cat("n=",SamSize,"Replication=",maxREP,OUTA,file="./Results/Ver1/Model 1/Model1n600q50.txt",sep="\n", append = FALSE)
