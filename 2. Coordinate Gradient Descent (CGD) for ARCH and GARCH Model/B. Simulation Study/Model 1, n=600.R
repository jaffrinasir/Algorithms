setwd("C:/Users/Jaffri/Dropbox/PhD Research/4. Third Year/3. Thesis Write up/Simulation Studies-Rcode/B. Pure GARCH models/B. Simulation Study")
### LOAD R PACKAGES #######################################
library(rpgm)
library(robustbase)
library(mvtnorm)
...
cat("n=",SamSize,"Replication=",maxREP,OUTA,file="./Results/Model 1/Model1n600.txt",sep="\n", append = FALSE)
