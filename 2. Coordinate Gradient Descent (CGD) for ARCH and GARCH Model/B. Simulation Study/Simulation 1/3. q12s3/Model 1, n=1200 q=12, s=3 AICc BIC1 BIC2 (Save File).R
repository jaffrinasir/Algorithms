...
coefARCH<-cbind(paraGA0, paraGAa1, paraGAa2, paraGAa3,paraGAa4,
                         ...
                         paraGAa9, paraGAa10, paraGAa11,paraGAa12,matrix(0,ncol=3))

LAGNONZERO<-c(1,2,5,7,11,13)   #LOCATION OF NONZERO PARAMETERS
LAGNONZERO2<-c(1,1,0,0,1,0,1,0,0,0,1,0,1,rep(0,3))  #1: non-zero 0: zero
...
save(LISTA,file=paste("Rlistq12s3/1200/SIMUAIC1200MODEL1.(",REPLICATE,").RData",sep = ""))
}
