...
GARCH1<-GARCH(SamSize,REPLICATE)
ERR<-as.vector(GARCH1$Y1)[1:(TRAIN/100*SamSize)]
ERRa<-as.vector(GARCH1$Y1)[((TRAIN/100*SamSize)+1):SamSize]
...
save(LISTA,file=paste("Rlistq1s3/2400/SIMU2400MODEL1.(",REPLICATE,").RData",sep = ""))
}
...
LAGNONZERO2<-c(1,1,0,0,0,1,0,1)  #1: non-zero 0: zero
ALLDATA<-list(Y1,err,coefGARCH,rCh,sCh,LAGNONZERO,LAGNONZERO2,sum(LAGNONZERO2))
names(ALLDATA)<-c("Y1","err","coefGARCH","Gr","Gs","LAGNONZERO","LAGNONZERO2","COUNTNZ")
return(ALLDATA)
}
...
LISTA<-list(assign(paste("LIST",REPLICATE,sep=""),LISTsimu))
save(LISTA,file=paste("Rlistq4s3/2400/SIMU2400MODEL1.(",REPLICATE,").RData",sep = ""))
}
...
LISTA<-list(assign(paste("LIST",REPLICATE,sep=""),LISTsimu))
save(LISTA,file=paste("Rlistq1s6/2400/SIMU2400MODEL1.(",REPLICATE,").RData",sep = ""))
}
...
LISTA<-list(assign(paste("LIST",REPLICATE,sep=""),LISTsimu))
save(LISTA,file=paste("Rlistq4s6/2400/SIMU2400MODEL1.(",REPLICATE,").RData",sep = ""))
}